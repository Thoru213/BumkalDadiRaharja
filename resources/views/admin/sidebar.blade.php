<div class="sidebar">
    <ul>
        ...
        <li><a href="{{ route('admin.settings.tentang-kami') }}"><i class="fas fa-info-circle"></i> Tentang Kami</a></li>
        <li><a href="{{ route('admin.settings.kontak') }}"><i class="fas fa-map-marker-alt"></i> Kontak</a></li>
    </ul>
</div>
