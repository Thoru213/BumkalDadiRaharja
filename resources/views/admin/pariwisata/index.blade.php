...
<div style="padding: 2rem;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="{{ route('admin.pariwisata.create') }}" style="background: #2d6a4f; color: white; padding: 0.7rem 1.5rem; text-decoration: none; border-radius: 5px;">+ Tambah Data</a>
    </div>
        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #e0e0e0;">
                ...
                <td style="padding: 1rem; text-align: center;">
                    <a href="{{ route('admin.pariwisata.edit', $item) }}" style="background: #ffc107; color: white; padding: 0.5rem 1rem; text-decoration: none; border-radius: 3px; margin-right: 0.5rem;">Edit</a>
                    <form action="{{ route('admin.pariwisata.destroy', $item) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
