        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #e0e0e0;">
                ...
                <td style="padding: 1rem; text-align: center;">
                    <a href="{{ route('admin.pertanian.edit', $item) }}" style="background: #ffc107; color: white; padding: 0.5rem 1rem; text-decoration: none; border-radius: 3px; margin-right: 0.5rem;">Edit</a>
                    <form action="{{ route('admin.pertanian.destroy', $item) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
