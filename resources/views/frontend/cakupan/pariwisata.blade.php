...
@section('title', 'Pariwisata - Gugur Gunung')
...
<section>
    <h2 style="text-align: center; margin-bottom: 2rem;">Pariwisata</h2>
    
    <img src="{{ asset('assets/images/pariwisata.jpg') }}" alt="Pariwisata" class="cakupan-img">
    
    <p style="text-align: justify; max-width: 800px; margin: 0 auto 3rem; line-height: 1.8; color: #555;">
        Bumkal Dadi Raharja memiliki potensi besar di sektor pariwisata melalui
        pengembangan konsep eduwisata berbasis agrowisata. Konsep ini memadukan
        rekreasi dan edukasi, dimana pengunjung dapat menikmati keindahan alam
        pedesaan sambil belajar tentang pertanian, peternakan, dan pengelolaan
        lingkungan berkelanjutan. Selain memberikan pengalaman wisata yang
        berkesan, kegiatan ini juga menumbuhkan kesadaran pentingnya sektor
        pertanian serta mendorong inovasi generasi muda.
    </p>
    
    @if($pariwisataData->count() > 0)
